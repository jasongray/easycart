...
<div class="portlet-content">
	...
	<?php } ?>
		<div class="user-card">
			...
			<div class="details">
				<p><strong><?php echo $user['User']['surname']; ?>, <?php echo $user['User']['firstname']; ?></strong><br/><?php echo $user['User']['mobile']; ?><br/><?php echo $this->XHtml->mailto($user['User']['email']); ?><br/><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $user['User']['id'])); ?></p>
			</div> 
		</div>
