	...
	<table cellpadding="0" cellspacing="0" id="adminForm" class="display">
		...
		<tr class="rowcontent<?php echo $k;?>">
			...
			<td class="actions">
				...
				<?php echo $this->Html->link($this->Html->image('gr_delete.png', array('alt' => 'Delete')), array('action' => 'delete', $s['Category']['id']), array('escape' => false), null, sprintf(__('Are you sure you want to delete # %s?'), $s['Category']['id'])); ?>
			</td>
		</tr>
		<?php $k = 1 - $k;
		} 
