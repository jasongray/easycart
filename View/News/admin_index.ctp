...
<h4><?php echo __('News Articles');?></h4>
</div>
<div class="portlet-content">
	...
	<table cellpadding="0" cellspacing="0" id="adminForm" class="display">
		...
		<td class="actions">
			...
			<?php echo $this->Html->link($this->Html->image('gr_delete.png', array('alt' => 'Delete')), array('action' => 'delete', $article['News']['id']), array('escape' => false), null, sprintf(__('Are you sure you want to delete # %s?'), $article['News']['id'])); ?>
		</td>
	</tr>
	<?php $k = 1 - $k;
	} 
