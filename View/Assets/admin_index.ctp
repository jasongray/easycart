		...
		for($i=0;$i<count($files);$i++){ 
			...
			if( strstr($f['Asset']['mime'], 'image') ){ 
				...
				<td class="actions">	
					...
					<?php echo $this->Html->link($this->Html->image('gr_delete.png', array('alt' => 'Delete')), array('action' => 'delete', $f['Asset']['id']), array('escape' => false), null, sprintf(__('Are you sure you want to delete # %s?'), $f['Asset']['id'])); ?>
				</td>
			</tr>
		<?php } ?>	
		</table>
