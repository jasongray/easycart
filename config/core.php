 ...
 */
	Configure::write('Session.cookie', 'nswdistributors');
 ...
 */
	Configure::write('Security.salt', '^&T*Y(OPUJKLZ:NHVGYTDRE%^&RT*YIOUUGYFTO&*^&(G*HIPJO{K":LMNKKHf8toi35j;etl&^%21vj3gihuojkl');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7418102973809129029381982378497284999718231478618473712828183789');
