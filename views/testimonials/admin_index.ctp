...
<h4><?php echo __('Testimonials', true);?></h4>
</div>
<div class="portlet-content">
	...
	<table cellpadding="0" cellspacing="0" id="adminForm" class="display">
		...
		<td class="actions">
			...
			<?php echo $this->Html->link($this->Html->image('gr_delete.png', array('alt' => 'Delete')), array('action' => 'delete', $article['Testimonial']['id']), array('escape' => false), null, sprintf(__('Are you sure you want to delete # %s?', true), $article['Testimonial']['id'])); ?>
		</td>
	</tr>
	<?php $k = 1 - $k;
	} 
