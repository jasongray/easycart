...
<h4><?php echo __('Menu Items', true);?></h4>
</div>
...
<?php echo $this->Html->link('<span></span> Add Items', '/admin/menuItems/add/menu_id:'.$this->passedArgs['menu_id'], array('class'=>'btn-icon btn-teal btn-plus', 'escape' => false))?>
	...
	<table cellpadding="0" cellspacing="0" id="adminForm" class="display">
		...
		<td class="actions">
			...
			<?php echo $this->Html->link($this->Html->image('gr_delete.png', array('alt' => 'Delete')), array('action' => 'delete', $menu['MenuItem']['id'] . '/menu_id:' . $this->passedArgs['menu_id']), array('escape' => false), null, sprintf(__('Are you sure you want to delete # %s?', true), $menu['MenuItem']['id'])); ?>
		</td>
	</tr>
	<?php $k = 1 - $k;
	} 
