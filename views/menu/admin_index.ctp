...
<?php echo $this->Html->link('<span></span> Create Menu', '/admin/menus/add', array('class'=>'btn-icon btn-teal btn-plus', 'escape' => false))?>
	...
	<table cellpadding="0" cellspacing="0" id="adminForm" class="display">
		...
		<td class="actions">
			...
			<?php echo $this->Html->link($this->Html->image('gr_delete.png', array('alt' => 'Delete')), array('action' => 'delete', $menu['Menu']['id']), array('escape' => false), null, sprintf(__('Are you sure you want to delete # %s?', true), $menu['Menu']['id'])); ?>
		</td>
	</tr>
	<?php $k = 1 - $k;
	} 
