...
<h4><?php echo __('Galleries', true);?></h4>
</div>
...
<?php echo $this->Html->link('<span></span> Create Gallery', '/admin/galleries/add', array('class'=>'btn-icon btn-teal btn-plus', 'escape' => false))?>
	...
	<table cellpadding="0" cellspacing="0" id="adminForm" class="display">
		...
		<td class="actions">
			...
			<?php echo $this->Html->link($this->Html->image('gr_delete.png', array('alt' => 'Delete')), array('action' => 'delete', $g['Gallery']['id']), array('escape' => false), null, sprintf(__('Are you sure you want to delete # %s?', true), $g['Gallery']['id'])); ?>
		</td>
	</tr>
	<?php $k = 1 - $k;
	} 
