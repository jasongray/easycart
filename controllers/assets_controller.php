...
class AssetsController extends AppController {
	...
	function admin_add() {
		if (!empty($this->data)) {
			...
			if ($this->saveFile($this->data)) {
				$this->Session->setFlash(__('The files has been saved', true), 'flash_success');
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The files could not be saved. Please, try again.', true), 'flash_error');
				$this->redirect(array('action' => 'index'));
			}
		}
	}
	...
	function admin_edit($id = null) {
		if (!$id && empty($this->data)) {
			$this->Session->setFlash(__('Invalid files', true), 'flash_error');
			$this->redirect(array('action' => 'index'));
		}
		if (!empty($this->data)) {
	...
	function admin_delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Invalid id for files', true), 'flash_error');
			$this->redirect(array('action'=>'index'));
		}
		if ($this->removeFile($id, true)) {
			$this->Session->setFlash(__('Assets deleted', true), 'flash_success');
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Assets was not deleted', true), 'flash_error');
		$this->redirect(array('action' => 'index'));
	}
