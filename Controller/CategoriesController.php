...
class CategoriesController extends AppController {
	...
	function view($id = null){
		...
		if (!$id) {
			$this->Session->setFlash(__('Invalid category'), 'flash_error');
	...
	function admin_delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Invalid id for category'), 'flash_error');
			$this->redirect(array('action'=>'index'));
		}
		if ($this->Category->delete($id)) {
			$this->Session->setFlash(__('Category deleted'), 'flash_success');
			$this->redirect(array('action'=>'index'));
		}
