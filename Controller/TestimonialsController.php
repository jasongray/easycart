...
class TestimonialsController extends AppController {
	...
	function view($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Invalid testimonials'), 'flash_error');
	...
	function admin_add() {
		if (!empty($this->data)) {
			...
			if ($this->Testimonial->save($this->data)) {
				...
				$this->Session->setFlash(__('The testimonial has been saved'), 'flash_success');
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The testimonial could not be saved. Please, try again.'), 'flash_error');
			}
		}
	}
	...
	function admin_edit($id = null) {
		if (!$id && empty($this->data)) {
			$this->Session->setFlash(__('Invalid testimonial'), 'flash_error');
			$this->redirect(array('action' => 'index'));
		}
		if (!empty($this->data)) {
			App::uses('Inflector', 'Utility');
	...
	function admin_delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Invalid id for testimonial'), 'flash_error');
			$this->redirect(array('action'=>'index'));
		}
		if ($this->Testimonial->delete($id)) {
			$this->Session->setFlash(__('Testimonial deleted'), 'flash_success');
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Testimonial was not deleted'), 'flash_error');
		$this->redirect(array('action' => 'index'));
	}
}
?>