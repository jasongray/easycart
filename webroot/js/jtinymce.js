$(document).ready(function(){
	$('textarea.tinymce').tinymce({
		...
		script_url : _baseurl+'js/tiny_mce/tiny_mce.js',
		...
		theme_advanced_buttons4 : "insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,template,pagebreak,|,image,insertimage",
		...
		content_css : _baseurl+"css/editor.css",
