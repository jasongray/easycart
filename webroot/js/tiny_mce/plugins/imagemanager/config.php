...
//echo dirname(dirname(dirname(dirname(dirname(__FILE__))))) . DIRECTORY_SEPARATOR . 'img' . DIRECTORY_SEPARATOR . 'articles';
	// * * * * ImageManager config
	...
	$mcImageManagerConfig['filesystem.rootpath'] = dirname(dirname(dirname(dirname(dirname(__FILE__))))) . DIRECTORY_SEPARATOR . 'img'; // absolute or relative from this script path, required.
