...
<tr>
	...
	$headers = array($paginator->sort(__d('acl', 'name'), $user_display_field));
...
?>
    ...
    <?php
    //echo $this->Html->link(___('generate missing AROs'), array('plugin' => 'acl', 'controller' => 'aros', 'action' => 'generate_missing'));
    ?>
