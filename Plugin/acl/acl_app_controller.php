...
class AclAppController extends AppController
{
	...
	private function _check_config()
	{
		...
		{
			$this->Session->setFlash(__('The role model name is unknown. The ACL plugin bootstrap.php file has to be loaded in order to work. (see the README file)'), 'flash_error');
		}
	}
